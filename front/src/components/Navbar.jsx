          ...
          <div className="hidden md:flex items-center space-x-2">
            ...
            {isLoggedIn && (
              <div className="relative ml-2">
                ...
                {menuOpen && (
                  <div className="absolute right-0 mt-2 w-56 bg-gray-800 rounded-lg shadow-2xl py-2 z-50 border border-gray-700 animate-in fade-in slide-in-from-top-2 duration-200">
                    <Link
                      to="/profile"
                      className="flex items-center px-4 py-3 text-gray-300 hover:text-white hover:bg-gray-700/70 transition-colors duration-150"
                    ...
                    <button
                      onClick={logout}
                      className="flex items-center w-full text-left px-4 py-3 text-gray-300 hover:text-red-400 hover:bg-gray-700/70 transition-colors duration-150"
                    >
          ...
          {isLoggedIn && (
            <>
              ...
              <button
                ...
                className="block w-full text-left px-4 py-3 text-gray-300 hover:text-red-400 hover:bg-gray-700/70 rounded-lg transition-all duration-150"
              >
                Logout
              </button>
            </>
