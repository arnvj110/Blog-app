...
export default function Home() {
    ...
    const { data: posts, isLoading, isError } = usePosts(search);
  ...
  className="group bg-gray-900 border border-gray-700 rounded-xl overflow-hidden 
  hover:bg-gray-800/70 hover:border-gray-600 transition-all duration-300 
  shadow-xl
...
>
  ...
  <div className="p-6 flex-1 flex flex-col">
    ...
    <div className="text-gray-300 text-sm line-clamp-3 flex-1 overflow-hidden markdown-preview">
      <MarkdownPreview
